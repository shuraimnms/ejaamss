...
export const Route = createFileRoute("/archives/year")({
  head: () => ({
    meta: [
      { title: "Archives by Year — EJAAMSS" },
      { name: "description", content: "Browse EJAAMSS archives by year." },
      { property: "og:title", content: "Archives by Year — EJAAMSS" },
      { property: "og:description", content: "Browse EJAAMSS archives by year." },
    ],
