...
export const Route = createFileRoute("/associate-editors")({
  head: () => ({
    meta: [
      { title: "Associate Editors — EJAAMSS" },
      { name: "description", content: "Meet the subject editors who handle submissions across finance, marketing, HR, operations, and strategy at EJAAMSS." },
      { property: "og:title", content: "Associate Editors — EJAAMSS" },
      { property: "og:description", content: "EJAAMSS's subject-specialist editorial team." },
    ],
