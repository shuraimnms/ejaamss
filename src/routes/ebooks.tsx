...
export const Route = createFileRoute("/ebooks")({
  head: () => ({
    meta: [{ title: "E-Books — EJAAMSS" }, { name: "description", content: "Open-access e-books curated by EJAAMSS." }],
...
function Ebooks() {
  ...
  return (
    <SiteLayout>
      <PageHero eyebrow="Library" title="E-Books" intro="Curated open-access volumes drawn from EJAAMSS research." />
