...
export const Route = createFileRoute("/conferences")({
  head: () => ({
    meta: [
      { title: "Conferences — EJAAMSS" },
      { name: "description", content: "EJAAMSS-affiliated conferences, symposia, and workshops." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Academic events organised or co-hosted by EJAAMSS."
      />
