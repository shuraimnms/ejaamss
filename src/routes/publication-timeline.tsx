  ...
  head: () => ({
    meta: [
      { title: "Publication Frequency — EJAAMSS" },
      {
        name: "description",
        content:
          "EJAAMSS publishes four regular quarterly issues every year — March, June, September, and December — with occasional special and theme-based issues.",
      },
      { property: "og:title", content: "Publication Frequency — EJAAMSS" },
      {
        property: "og:description",
        content: "Quarterly publication schedule and special-issue policy of EJAAMSS.",
      },
    ],
