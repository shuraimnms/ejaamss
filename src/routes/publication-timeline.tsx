...
export const Route = createFileRoute("/publication-timeline")({
  head: () => ({
    meta: [
      { title: "Publication Frequency — EJAAMSS" },
      { name: "description", content: "EJAAMSS publishes four regular quarterly issues every year — March, June, September, and December — with occasional special and theme-based issues." },
      { property: "og:title", content: "Publication Frequency — EJAAMSS" },
      { property: "og:description", content: "Quarterly publication schedule and special-issue policy of EJAAMSS." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="EJAAMSS normally publishes four regular issues every year on a quarterly basis."
      />
      <div className="container-page py-12">
        ...
        <section className="mt-12">
          ...
          <div className="mt-2 rule-gold" />
          <p className="mt-3 text-sm text-muted-foreground">EJAAMSS may also publish:</p>
