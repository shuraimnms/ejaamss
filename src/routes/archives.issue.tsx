...
export const Route = createFileRoute("/archives/issue")({
  head: () => ({
    meta: [
      { title: "Archives by Issue — EJAAMSS" },
      { name: "description", content: "Browse EJAAMSS archives by issue." },
      { property: "og:title", content: "Archives by Issue — EJAAMSS" },
      { property: "og:description", content: "Browse EJAAMSS archives by issue." },
    ],
