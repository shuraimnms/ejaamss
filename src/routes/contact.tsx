  ...
  head: () => ({
    meta: [
      { title: "Contact — EJAAMSS" },
      {
        name: "description",
        content:
          "Contact the EJAAMSS editorial office for submissions, editorial enquiries, reviewer registration, ethics complaints, and technical support.",
      },
          ...
          <div>
            ...
            >
              ...
              <label className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <span>
                  I consent to EJAAMSS storing the information above solely to respond to my
                  enquiry.
                </span>
              </label>
              <button
            ...
            <div className="rounded-2xl border border-border bg-card p-6 text-sm">
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <a href={`mailto:editor@ejaamss.com`} className="hover:text-brand">
                    editor@ejaamss.com
                  </a>
                </div>
                <div className="flex items-start gap-3">
                  <Globe className="mt-0.5 h-4 w-4 text-brand" />
                  <span>ejaamss.com</span>
                </div>
                <div className="flex items-start gap-3">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {CONTACT_CHANNELS.map((c) => (
              <article key={c.title} className="rounded-xl border border-border bg-card p-5">
                ...
                <a
                  href={`mailto:editor@ejaamss.com`}
