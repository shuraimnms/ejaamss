...
export const Route = createFileRoute("/advisory-board")({
  head: () => ({
    meta: [
      { title: "International Advisory Board — EJAAMSS" },
      { name: "description", content: "Senior scholars and practitioners advising EJAAMSS on strategic direction, ethics, and long-term editorial policy." },
      { property: "og:title", content: "Advisory Board — EJAAMSS" },
      { property: "og:description", content: "Strategic advisors to EJAAMSS." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Distinguished scholars and practitioners who shape EJAAMSS's long-term direction, ethics posture, and international presence."
      />
      <div className="container-page py-12">
        ...
        <CtaStrip
          ...
          title="Full transparency about how EJAAMSS is run"
