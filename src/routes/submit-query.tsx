  ...
  head: () => ({
    meta: [
      { title: "Submit a Query — EJAAMSS" },
      {
        name: "description",
        content:
          "Send a structured query to the EJAAMSS editorial or technical team and get a reply within two working days.",
      },
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Editorial:{" "}
                <a href="mailto:editorial@ejaamss.com" className="text-brand hover:underline">
                  editorial@ejaamss.com
                </a>
                <br />
                Support:{" "}
                <a href="mailto:support@ejaamss.com" className="text-brand hover:underline">
                  support@ejaamss.com
                </a>
              </p>
            </div>
