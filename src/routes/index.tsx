          ...
          <div className="w-full max-w-[500px] bg-[#0f172a]/95 backdrop-blur-sm p-8 md:p-10 rounded-tr-[40px] rounded-br-[10px] rounded-tl-[10px] rounded-bl-[10px] shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-white font-medium text-sm tracking-wider uppercase w-24">AEROSPACE</span>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-white font-medium text-sm tracking-wider uppercase w-24">AVIATION</span>
                <div className="flex-1 flex items-center">
                  <div className="h-[1px] bg-white/20 flex-1"></div>
                  <div className="w-1.5 h-1.5 rounded-full bg-[#f59e0b]"></div>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-white font-medium text-sm tracking-wider uppercase w-24">MARITIME</span>
                <div className="flex-1 flex items-center">
                  <div className="h-[1px] bg-white/20 flex-1"></div>
                  <div className="w-1.5 h-1.5 rounded-full bg-[#f59e0b]"></div>
                </div>
