  ...
  head: () => ({
    meta: [
      { title: "EJAAMSS — European Journal of Aerospace, Aviation and Maritime Spectrum Studies" },
      {
        name: "description",
        content:
          "EJAAMSS is a peer-reviewed, open access journal publishing innovative research in aerospace engineering, aviation science, maritime technology, and transportation systems.",
      },
...
const FEATURES = [
  { icon: Zap, title: "European Research Focus", body: "Leading insights from across the continent" },
  { icon: Unlock, title: "Open Access", body: "Freely available for reading and download" },
  { icon: ShieldCheck, title: "Engineering Excellence", body: "High quality technical publications" },
    ...
    <SiteLayout>
            ...
            <div className="grid gap-8 md:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] items-start">
              ...
              <div>
                <h1 className="font-serif text-3xl md:text-4xl lg:text-[2.6rem] font-bold uppercase leading-[1.15] text-brand">
                  ...
                  <span className="block text-brand/90">(EJAAMSS)</span>
                </h1>
                <p className="mt-5 text-[15px] leading-relaxed text-muted-foreground max-w-xl">
                  EJAAMSS is a peer-reviewed, open access journal committed to publishing
                  innovative and influential research in all areas of aerospace engineering,
                  aviation science, maritime technology, and transportation systems.
                </p>
              ...
              <div className="mx-auto w-full max-w-[280px]">
                <div className="relative aspect-[3/4] rounded-sm border border-border bg-[oklch(0.97_0.02_75)] shadow-elev overflow-hidden">
                  ...
                  <div className="flex h-full flex-col items-center justify-center px-6 text-center">
                    <div className="font-serif text-4xl font-bold text-brand">EJAAMSS</div>
        ...
        <div className="container-page relative py-14 lg:py-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm md:text-[15px] text-white/75">
              EJAAMSS has been advancing peer-reviewed research in aerospace, aviation, maritime engineering,
              and transportation systems with global visibility, ethical publishing and open access.
            </p>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-sm md:text-[15px] text-muted-foreground leading-relaxed">
                EJAAMSS welcomes original manuscripts across aerospace engineering, aviation science,
                maritime technology, transportation systems, and allied interdisciplinary domains,
                from empirical studies and conceptual reviews to technical notes and policy analysis.
              </p>
              <Link
                to="/aims-scope"
          ...
          <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
            <div className="text-white">
              ...
              <p className="mt-3 max-w-xl text-sm md:text-[15px] text-white/80">
                Original, unpublished research in aerospace engineering, aviation science, maritime
                technology, and transportation systems is invited. Fast-track peer review, DOI on acceptance, and open access indexing.
              </p>
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  to="/submit"
      ...
      <section className="border-t border-border bg-card">
        <div className="container-page grid gap-6 py-8 md:grid-cols-3">
          ...
          <ContactItem icon={Globe2} label="WEBSITE" value="www.ejaamss.com" />
          <ContactItem icon={MapPin} label="ADDRESS" value="Europe" />
        </div>
      </section>
    </SiteLayout>
  );
