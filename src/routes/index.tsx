        ...
        <div className="relative z-10 container-page h-full flex items-center">
          <div className="w-full max-w-[500px] bg-[#0f172a]/95 backdrop-blur-sm p-8 md:p-10 rounded-tr-[40px] rounded-br-[10px] rounded-tl-[10px] rounded-bl-[10px] shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link
                to="/current-issue"
                className="bg-[#f59e0b] hover:bg-[#c2984b] text-[#0f172a] font-medium text-sm px-6 py-2.5 rounded-sm transition-colors"
              >
                Explore Research
              </Link>
              <Link
                to="/submit"
                className="bg-transparent border border-[#f59e0b] text-[#f59e0b] hover:bg-[#f59e0b]/10 font-medium text-sm px-6 py-2.5 rounded-sm transition-colors"
              >
                Submit Manuscript
              </Link>
            </div>
