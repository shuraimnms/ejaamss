...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "EJAAMSS — European Journal of Aerospace, Aviation and Maritime Spectrum Studies",
      },
      {
        property: "og:description",
        content:
          "Peer-reviewed, open access quarterly journal in aerospace, aviation and maritime studies.",
      },
    ],
    ...
    <SiteLayout>
      ...
      <section className="relative w-full min-h-[100svh] md:min-h-[600px] lg:min-h-[700px] overflow-hidden bg-[#0f172a]">
        ...
        <Link
          ...
          className="hidden md:flex absolute right-0 top-[20%] z-30 bg-[#d97706] text-white py-4 px-2 rounded-l-md font-bold text-sm tracking-widest writing-mode-vertical hover:bg-[#b45309] transition-colors shadow-lg"
          ...
          <div className="w-full max-w-[650px] bg-transparent px-4 py-24 sm:px-6 md:py-10 md:px-10 md:pt-16 relative z-10">
            ...
            <h1 className="font-serif text-[32px] sm:text-4xl md:text-5xl lg:text-[56px] leading-[1.25] md:leading-[1.15] font-bold text-white mb-6 drop-shadow-lg">
              ...
              <span className="text-[#f59e0b]">
                Aerospace, Aviation and Maritime Spectrum Studies
              </span>
            </h1>
            ...
            <div className="space-y-4 max-w-[320px]">
              <div className="flex items-center gap-4">
                <div className="w-6 flex justify-center">
                  <Stamp className="h-5 w-5 text-[#f59e0b]" />
                </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-sm md:text-[15px] text-muted-foreground leading-relaxed">
                EJAAMSS welcomes original manuscripts across commerce, management, finance and
          ...
          <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
            <div className="text-white">
              ...
              <p className="mt-3 max-w-xl text-sm md:text-[15px] text-white/80">
                Original, unpublished research in aerospace, aviation, maritime and allied
                engineering disciplines is invited. Fast-track peer review, DOI on acceptance, and
