...
export const Route = createFileRoute("/super-admin/login")({
  head: () => ({
    meta: [
      { title: "Super Admin Portal — EJAAMSS" },
      { name: "description", content: "Centralized journal management system. Authorized administrators only." },
    ...
    >
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mt-2 font-serif text-2xl font-semibold text-white">Centralized Journal Management</h1>
