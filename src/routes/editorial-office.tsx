  ...
  head: () => ({
    meta: [
      { title: "Editorial Office — EJAAMSS" },
      {
        name: "description",
        content:
          "Contact details, working hours, and remit of the EJAAMSS editorial office — the operational heart of the journal.",
      },
...
const CHANNELS = [
  {
    ...
    value: "editorial@ejaamss.com",
    href: "mailto:editorial@ejaamss.com",
  },
  {
    icon: Mail,
    label: "Technical support",
    value: "support@ejaamss.com",
    href: "mailto:support@ejaamss.com",
  },
  {
    icon: Phone,
  ...
  },
  {
    ...
    value: "EJAAMSS Editorial Office, Registered Address (to be published).",
    href: "#",
  },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "EJAAMSS operates a distributed editorial team. All correspondence is handled by email; in-person meetings are by scheduled appointment at conferences.",
  },
  {
    q: "Whom should I contact about DOIs or metadata corrections?",
    a: "Email editorial@ejaamss.com with your article DOI and the correction requested. Metadata is re-deposited with Crossref within five working days.",
  },
];
