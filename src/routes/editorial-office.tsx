...
export const Route = createFileRoute("/editorial-office")({
  head: () => ({
    meta: [
      { title: "Editorial Office — EJAAMSS" },
      { name: "description", content: "Contact details, working hours, and remit of the EJAAMSS editorial office — the operational heart of the journal." },
      { property: "og:title", content: "Editorial Office — EJAAMSS" },
      { property: "og:description", content: "How to reach the EJAAMSS editorial office." },
    ],
...
const CHANNELS = [
  { icon: Mail, label: "Editorial email", value: "editorial@ejaamss.com", href: "mailto:editorial@ejaamss.com" },
  { icon: Mail, label: "Technical support", value: "support@ejaamss.com", href: "mailto:support@ejaamss.com" },
  { icon: Phone, label: "Phone (office hours)", value: "+91 000 000 0000", href: "tel:+910000000000" },
  { icon: MapPin, label: "Correspondence", value: "EJAAMSS Editorial Office, Registered Address (to be published).", href: "#" },
];
...
const FAQS = [
  ...
  { q: "Can I visit the editorial office?", a: "EJAAMSS operates a distributed editorial team. All correspondence is handled by email; in-person meetings are by scheduled appointment at conferences." },
  { q: "Whom should I contact about DOIs or metadata corrections?", a: "Email editorial@ejaamss.com with your article DOI and the correction requested. Metadata is re-deposited with Crossref within five working days." },
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="The EJAAMSS editorial office is the operational heart of the journal — coordinating peer review, ethics, production, and post-publication support."
      />
