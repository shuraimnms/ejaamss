...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About EJAAMSS — European Journal of Aerospace, Aviation and Maritime Spectrum Studies" },
      { name: "description", content: "EJAAMSS is dedicated to publishing high-quality research in aerospace engineering, aviation science, maritime technology, naval architecture, transportation systems, intelligent mobility, and emerging engineering technologies that support the future of global air and sea transportation." },
      { property: "og:title", content: "About EJAAMSS" },
      { property: "og:description", content: "EJAAMSS is dedicated to publishing high-quality research in aerospace, aviation, and maritime studies." },
    ],
...
const JOURNAL_DETAILS: [string, string][] = [
  ["Full Title", "European Journal of Aerospace, Aviation and Maritime Spectrum Studies"],
  ["Abbreviation", "EJAAMSS"],
  ["Print ISSN", "xxxx-xxxx"],
  ["Online ISSN", "xxxx-xxxx"],
  ["Country of Publication", "European Union"],
  ["Language", "English"],
  ...
  ["Website", "ejaamss.com"],
  ["Editorial Email", "editor@ejaamss.com"],
];
...
const FAQS = [
  { q: "Is EJAAMSS peer-reviewed?", a: "Yes. Every manuscript is evaluated through an external double-blind peer-review process by subject-matter reviewers." },
  { q: "How often does EJAAMSS publish?", a: "EJAAMSS normally publishes four regular issues every year — in March, June, September, and December." },
  ...
  { q: "Which subject areas are accepted?", a: "Aerospace engineering, aviation science, maritime technology, naval architecture, transportation systems, intelligent mobility, and emerging engineering technologies. See Focus & Scope." },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title="European Journal of Aerospace, Aviation and Maritime Spectrum Studies"
        intro="EJAAMSS is dedicated to publishing high-quality research in aerospace engineering, aviation science, maritime technology, naval architecture, transportation systems, intelligent mobility, and emerging engineering technologies that support the future of global air and sea transportation."
      >
      ...
      <div className="container-page py-12">
        ...
        <section className="mt-14 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              Manuscripts may be empirical, analytical, conceptual, quantitative, qualitative, or mixed-method, provided they make a meaningful contribution to knowledge, policy, professional practice, engineering education, or socio-economic development.
            </p>
            <p className="mt-3 text-muted-foreground leading-relaxed">
              All manuscripts submitted to EJAAMSS are initially screened by the editorial office for relevance, originality, formatting, plagiarism, language quality, ethical compliance, and adherence to journal guidelines. Manuscripts found suitable are evaluated through an external double-blind peer-review process.
            </p>
          </div>
        ...
        <CtaStrip
          ...
          title="Submit your manuscript to EJAAMSS"
