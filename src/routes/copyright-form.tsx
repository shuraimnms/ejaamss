...
export const Route = createFileRoute("/copyright-form")({
  head: () => ({
    meta: [{ title: "Copyright Form — EJAAMSS" }, { name: "description", content: "Fillable Copyright Assignment Form for EJAAMSS manuscripts." }],
...
function CopyrightForm() {
  ...
  const generatePDF = () => {
    ...
    if (!w) return;
    w.document.write(`<html><head><title>EJAAMSS Copyright Form — ${state.manuscriptTitle}</title>
...
<h1>International Journal of Academic Research in Engineering & Aviation</h1>
...
<p>The undersigned assigns to EJAAMSS first-publication rights and the non-exclusive right to distribute the article under CC BY-NC 4.0, while retaining copyright.</p>
<h2>Signature</h2>
