...
export const Route = createFileRoute("/most-viewed")({
  head: () => ({
    meta: [
      { title: "Most Viewed Papers — EJAAMSS" },
      { name: "description", content: "The most-read EJAAMSS articles across all volumes, ranked by verified reader views." },
      { property: "og:title", content: "Most Viewed Papers — EJAAMSS" },
      { property: "og:description", content: "Top-read research from EJAAMSS." },
    ],
