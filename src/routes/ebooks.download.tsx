...
export const Route = createFileRoute("/ebooks/download")({
  head: () => ({
    meta: [
      { title: "Download E-Books — EJAAMSS" },
      { name: "description", content: "Download available EJAAMSS e-books." },
      { property: "og:title", content: "Download E-Books — EJAAMSS" },
      { property: "og:description", content: "Download available EJAAMSS e-books." },
    ],
