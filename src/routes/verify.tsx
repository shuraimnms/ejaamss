...
export const Route = createFileRoute("/verify")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Verify the authenticity of any EJAAMSS certificate by its tracking number.",
      },
      { property: "og:title", content: "Verify a Certificate — EJAAMSS" },
      {
        property: "og:description",
        content: "Verify EJAAMSS publication, reviewer, and conference certificates.",
      },
    ],
