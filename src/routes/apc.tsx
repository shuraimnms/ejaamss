  ...
  head: () => ({
    meta: [
      { title: "Publication Charges — EJAAMSS" },
      {
        name: "description",
        content:
          "EJAAMSS's publication charges policy, waiver conditions, refund terms, and ethical safeguards for authors.",
      },
      { property: "og:title", content: "Publication Charges — EJAAMSS" },
      {
        property: "og:description",
        content: "Publication and processing charges policy for EJAAMSS.",
      },
    ],
