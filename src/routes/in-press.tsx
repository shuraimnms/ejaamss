...
export const Route = createFileRoute("/in-press")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Accepted EJAAMSS manuscripts in final production, awaiting issue assignment and DOI registration." },
      { property: "og:title", content: "Articles In Press — EJAAMSS" },
      { property: "og:description", content: "Peer-reviewed manuscripts in final production at EJAAMSS." },
    ],
