...

  {
    ...
    items: [
      ...
      { label: "Subject Areas", to: "/aims-scope", description: "All accepted subject areas." },
      {
        ...
        to: "/aims-scope",
        description: "Aerospace engineering and sciences.",
      },
      { label: "Aviation", to: "/aims-scope", description: "Aviation and flight dynamics." },
      {
        label: "Maritime Technology",
        to: "/aims-scope",
        description: "Maritime technology and marine engineering.",
      },
      {
        label: "Naval Architecture",
        to: "/aims-scope",
        description: "Naval architecture and ship design.",
      },
      { label: "Transportation", to: "/aims-scope", description: "Transportation and logistics." },
      {
        label: "UAVs",
        to: "/aims-scope",
        description: "Unmanned aerial vehicles and drone technology.",
      },
      {
...

  {
    ...
    items: [
      ...
      },
      {
        label: "Publication",
        to: "/publication-process",
        description: "Final publication in EJAAMSS.",
      },
    ],
  },
