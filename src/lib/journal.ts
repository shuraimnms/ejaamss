...
export const JOURNAL = {
  ...
  address: "Editorial Office, EJAAMSS, India",
} as const;
...
export const NAV: NavGroup[] = [
...

  {
    ...
    items: [
      ...
      { label: "Vision", to: "/vision-mission", description: "Long-term vision of EJAAMSS." },
...

  {
    ...
    items: [
      ...
      { label: "Aerospace Engineering", to: "/aims-scope", description: "Aerospace engineering and sciences." },
      { label: "Aviation", to: "/aims-scope", description: "Aviation and flight dynamics." },
      { label: "Maritime Technology", to: "/aims-scope", description: "Maritime technology and marine engineering." },
      { label: "Naval Architecture", to: "/aims-scope", description: "Naval architecture and ship design." },
      { label: "Transportation", to: "/aims-scope", description: "Transportation and logistics." },
      { label: "UAVs", to: "/aims-scope", description: "Unmanned aerial vehicles and drone technology." },
      { label: "Interdisciplinary Research", to: "/aims-scope", description: "Interdisciplinary studies." },
    ],
  },
...

  {
    ...
    items: [
      ...
      { label: "Case Studies", to: "/articles", description: "Case studies published in EJAAMSS." },
...

  {
    ...
    items: [
      ...
      { label: "Publication", to: "/publication-process", description: "Final publication in EJAAMSS." },
    ],
  },
