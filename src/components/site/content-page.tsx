      ...
      <div className="min-w-0 space-y-10">
        ...
        <section className="rounded-2xl border border-border bg-card p-8">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            IJARCM is committed to transparent, ethical, and internationally-benchmarked academic publishing across commerce and management disciplines. Every policy on this site aligns with COPE guidelines, the DOAJ principles of transparency, and best practice for double-blind peer review. If a specific point on this page is not yet addressed, our editorial office will respond within two working days.
          </p>
