            ...
            <Fragment key={s.title}>
              <li
                ...
                style={
                  active
                    ? {
                        animation: `ijarcm-step-pop 0.55s cubic-bezier(0.34,1.56,0.64,1) ${nodeDelay} both`,
                      }
                    : undefined
                }
              >
                ...
                >
                  ...
                  {active && (
                    <span
                      ...
                      style={{
                        animation: `ijarcm-step-ring 1.1s ease-out ${nodeDelay} both`,
                  ...
                  <div
                    ...
                    style={
                      active
                        ? {
                            background: "var(--gold)",
                            animation: `ijarcm-step-arrow 0.4s ease-out ${arrowDelay} both`,
                          }
                        : { background: "var(--gold)" }
                    }
                  >
